...
import { getUUID, QUESTION_EVENT_KEY, QUESTION_RESULT_EVENT_KEY, SEARCH_CLOSED_EVENT_KEY, useSearchContext, } from '../../../utils';
import './styles.css';
export function Question() {
    const { type, setType, setVisible, setCatalog, setPlaceholder, } = useSearchContext();
