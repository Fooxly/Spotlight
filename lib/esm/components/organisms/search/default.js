...
import { getUUID, catalog, updateCatalog, Registry, REGISTRY_UPDATE_EVENT_KEY, useSearchContext, } from '../../../utils';
import './styles.css';
...
export function Default(props) {
    var _a, _b, _c, _d;
    const { type, visible, selectedItem, setType, setVisible, setPlaceholder, setSelectedItem, setLoading, } = useSearchContext();
    ...
    console.log('up to date catalog', (_d = (_c = (_b = (_a = catalog.items) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.children) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.id);
    const handleAction = useCallback((result, value) => __awaiter(this, void 0, void 0, function* () {
        var _e, _f, _g, _h;
        console.log((_h = (_g = (_f = (_e = catalog.items) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.children) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.id, result.id);
        if (result.parent) {
