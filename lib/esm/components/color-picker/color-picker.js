...
import { combineHexColors, getColorFromHex, getColorStringForMode, HSVAtoRGBA, RGBAToHex, HexToLuma, RGBAtoHSVA, HexToRGBA, } from '../../utils/colors';
...
export function ColorPicker({ setColorGrabberProps }) {
    ...
    const handleGrab = () => __awaiter(this, void 0, void 0, function* () {
    ...
    useHotkeys('enter', (e) => {
        ...
        if (navigator.clipboard) {
            ...
            toast(_jsxs(_Fragment, { children: ["Copied", '\u00A0', _jsx("span", Object.assign({ style: {
                            borderRadius: '5px',
    ...
    if (typeof window === 'undefined')
        return null;
    return ReactDOM.createPortal(!visible ? null : (_jsxs(Container, Object.assign({ ref: colorPickerRef, onMouseUp: () => setAreaFocus(false) }, { children: [_jsx(Background, { onClick: hideColorPicker }), _jsxs(Content, { children: [!!title && (_jsx(_Fragment, { children: _jsx(Title, { children: title }) })), _jsx(Picker, Object.assign({ ref: colorAreaDimsRef, onMouseDown: () => setAreaFocus(true), "$hasTitle": !!title, style: {
