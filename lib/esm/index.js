...
import { ColorGrabber, ColorPicker, SpotlightComponent, Toast } from './components';
...
export function Spotlight({ isDarkMode, onBranchSwitchCmd, showTips = true, showRecentlyUsed = 5, }) {
    ...
    const [colorGrabberProps, setColorGrabberProps] = useState(null);
    ...
    return (_jsxs(ThemeProvider, Object.assign({ theme: calculatedTheme }, { children: [_jsx(SpotlightComponent, { showTips: showTips }), _jsx(ColorPicker, { setColorGrabberProps: setColorGrabberProps }), _jsx(ColorGrabber, Object.assign({}, colorGrabberProps)), _jsx(Toast, {})] })));
}
