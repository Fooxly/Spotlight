...
import { SearchIcon, TimesIcon } from '../src/icons/line';
...
export function SearchInput({ hasResults, placeholder, value, loading, fref, onChange }) {
    ...
    return (_jsxs(SearchBar, { "$hasResults": hasResults, children: [_jsx(Input, { autoFocus: true, ref: fref, placeholder: placeholder ?? 'Search or jump to...', value: value, onChange: handleChange }), _jsx(SearchIconWrapper, { children: loading ? (_jsx(Loading, { size: 22, color: 'blue', thickness: 3 })) : (_jsx(SearchIcon, { size: 24, color: 'gray4' })) }), value?.length > 0 && (_jsx(CloseButton, { onClick: handleClear, children: _jsx(TimesIcon, { size: 8, color: 'gray10' }) }))] }));
}
