...
export function getColorFunction(colorSet) {
    ...
    var color = (function (c, fallback) {
        ...
        if (c.startsWith('#') || c.startsWith('rgb') || c === 'inherit')
            return c;
        return (_c = (_b = (_a = lens(colorSet, c)) !== null && _a !== void 0 ? _a : (fallback ? color(fallback) : undefined)) !== null && _b !== void 0 ? _b : c) !== null && _c !== void 0 ? _c : 'transparent';
    });
    try {
...
export var color = getColorFunction(colors);
