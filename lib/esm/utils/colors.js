...
export function RGBAToLuma(color) {
...
export function combineHexColors(hex1, hex2) {
...
export function getColorFromHex(mode, hex, alpha = true) {
    switch (mode) {
...
export function getColorStringForMode(mode, hex, alpha = true) {
...
export function strToHex(str, alpha = true) {
...
export function HexToHSLA(str) {
    return HSVAtoHSLA(RGBAtoHSVA(HexToRGBA(str)));
}
export function RGBAToHex(rgba, alpha = true) {
