...
export function getResultById(id, results) {
    var _a;
    const resultsArr = results !== null && results !== void 0 ? results : catalog.store;
    if (!id)
        return undefined;
...
export function getResultsByParentId(parentId, results) {
    var _a, _b;
    const resultsArr = results !== null && results !== void 0 ? results : catalog.items;
