...
function Spotlight({ isDarkMode, showRecentlyUsed = 5 }) {
    ...
    return ((0, jsx_runtime_1.jsx)(styled_components_1.ThemeProvider, { theme: calculatedTheme, children: (0, jsx_runtime_1.jsx)(components_1.SpotlightComponent, { showRecentlyUsed: showRecentlyUsed }) }));
}
