...
exports.shell = exports.question = exports.toast = exports.unregister = exports.registerCommand = exports.registerJumpTo = exports.Spotlight = void 0;
...
function Spotlight({ isDarkMode, showRecentlyUsed = 5, showTips = true }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(styled_components_1.ThemeProvider, Object.assign({ theme: calculatedTheme }, { children: [(0, jsx_runtime_1.jsx)(components_1.SpotlightComponent, { showTips: showTips }), (0, jsx_runtime_1.jsx)(components_1.Toast, {})] })));
}
...
function toast(message) {
    const handleRequest = (ev) => {
        ...
        document.removeEventListener(utils_1.TOAT_EVENT_KEY, handleRequest);
    };
    // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
    document.addEventListener(utils_1.TOAT_EVENT_KEY, handleRequest);
    const ev = new CustomEvent(utils_1.TOAT_EVENT_KEY, {
        bubbles: false,
        detail: {
            value: message,
        },
