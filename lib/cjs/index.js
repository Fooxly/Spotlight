...
function Spotlight({ isDarkMode, showRecentlyUsed = 5, showTips = true }) {
    ...
    return ((0, jsx_runtime_1.jsx)(styled_components_1.ThemeProvider, Object.assign({ theme: calculatedTheme }, { children: (0, jsx_runtime_1.jsx)(spotlight_1.SpotlightComponent, { showTips: showTips }) })));
}
