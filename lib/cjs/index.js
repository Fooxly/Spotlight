...
function Spotlight({ isDarkMode, onBranchSwitchCmd, showTips = true, showRecentlyUsed = 5, }) {
    const [darkMode, setDarkMode] = (0, react_1.useState)(isDarkMode !== null && isDarkMode !== void 0 ? isDarkMode : false);
    const [colorGrabberProps, setColorGrabberProps] = (0, react_1.useState)(null);
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (branchSwitched) {
            (0, commands_1.toast)(onBranchSwitchCmd ? 'Please wait ...' : 'Please wait for packages to update ...');
            url.searchParams.delete('spotlight-branch-switch');
            (0, commands_1.shell)(onBranchSwitchCmd !== null && onBranchSwitchCmd !== void 0 ? onBranchSwitchCmd : 'yarn')
                .then(() => {
                window.location.href = url.toString();
            })
                .catch(() => {
                (0, commands_1.toast)('Failed to update packages.');
            });
        }
    }, [onBranchSwitchCmd]);
    (0, react_1.useEffect)(() => {
    ...
    return ((0, jsx_runtime_1.jsxs)(styled_components_1.ThemeProvider, Object.assign({ theme: calculatedTheme }, { children: [(0, jsx_runtime_1.jsx)(components_1.SpotlightComponent, { showTips: showTips }), (0, jsx_runtime_1.jsx)(components_1.ColorPicker, { setColorGrabberProps: setColorGrabberProps }), (0, jsx_runtime_1.jsx)(components_1.ColorGrabber, Object.assign({}, colorGrabberProps)), (0, jsx_runtime_1.jsx)(components_1.Toast, {})] })));
}
