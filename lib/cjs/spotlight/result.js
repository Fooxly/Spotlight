...
function Result({ hasIcons, result, index, selected, onSoftSelect, onSelect }) {
    ...
    const Icon = ((_a = result.item.options) === null || _a === void 0 ? void 0 : _a.icon) ? (0, get_command_icon_1.getCommandIcon)((_b = result.item.options) === null || _b === void 0 ? void 0 : _b.icon) : null;
