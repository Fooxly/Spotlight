...
function Loading({ size = 25, color, thickness: rawThickness, }) {
    ...
    const rootStyle = {};
    const rootProps = {};
    return ((0, jsx_runtime_1.jsx)(Container, { ...rootProps, style: rootStyle, "$size": size, "$color": color, role: 'progressbar', children: (0, jsx_runtime_1.jsx)(Svg, { viewBox: `${size / 2} ${size / 2} ${size} ${size}`, children: (0, jsx_runtime_1.jsx)(Circle, { style: circleStyle, cx: size, cy: size, r: (size - thickness) / 2, fill: 'none', stroke: themeColor(color), strokeWidth: thickness }) }) }));
}
