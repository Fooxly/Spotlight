...
function Error({ message, onDismiss }) {
    return ((0, jsx_runtime_1.jsxs)(Container, { children: [(0, jsx_runtime_1.jsx)(Message, { children: message }), (0, jsx_runtime_1.jsx)(Button, { onClick: onDismiss, children: (0, jsx_runtime_1.jsx)(line_1.TimesIcon, { size: 15, color: 'red' }) })] }));
}
exports.Error = Error;
