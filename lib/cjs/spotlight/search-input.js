...
function SearchInput({ hasResults, placeholder, value, loading, fref, onChange }) {
    ...
    return ((0, jsx_runtime_1.jsxs)(SearchBar, Object.assign({ "$hasResults": hasResults }, { children: [(0, jsx_runtime_1.jsx)(Input, { autoFocus: true, ref: fref, placeholder: placeholder !== null && placeholder !== void 0 ? placeholder : 'Search or jump to...', value: value, onChange: handleChange }), (0, jsx_runtime_1.jsx)(SearchIconWrapper, { children: loading ? ((0, jsx_runtime_1.jsx)(loading_1.Loading, { size: 22, color: 'blue', thickness: 3 })) : ((0, jsx_runtime_1.jsx)(line_1.SearchIcon, { size: 24, color: 'gray4' })) }), (value === null || value === void 0 ? void 0 : value.length) > 0 && ((0, jsx_runtime_1.jsx)(CloseButton, Object.assign({ onClick: handleClear }, { children: (0, jsx_runtime_1.jsx)(line_1.TimesIcon, { size: 8, color: 'gray10' }) })))] })));
}
