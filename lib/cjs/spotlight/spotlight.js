...
exports.SpotlightComponent = exports.COMMANDS = void 0;
...
var base_commands_1 = require("./base-commands");
...
exports.COMMANDS = __spreadArray([], __read(base_commands_1.BASE_COMMANDS), false);
function SpotlightComponent() {
    var _a = __read((0, react_1.useState)(false), 2), visible = _a[0], setVisible = _a[1];
    var _b = __read((0, react_1.useState)(-1), 2), selectedIndex = _b[0], setSelectedIndex = _b[1];
    var _c = __read((0, react_1.useState)(''), 2), search = _c[0], setSearch = _c[1];
    ...
    var indexedResults = (0, react_1.useMemo)(function () { return search.trim().length === 0 ? exports.COMMANDS.slice(0, 8) : exports.COMMANDS.filter(function (cmd) {
        var _a, _b;
    ...
    var hasIcons = (0, react_1.useMemo)(function () { return indexedResults.filter(function (cmd) { var _a; return !!(0, get_command_icon_1.getCommandIcon)((_a = cmd.options) === null || _a === void 0 ? void 0 : _a.icon); }).length > 0; }, [indexedResults]);
    ...
    (0, react_hotkeys_hook_1.useHotkeys)('cmd+shift+k, ctrl+shift_k', function (e) {
        e.preventDefault();
        e.stopPropagation();
        toggleVisible();
    }, {
    ...
    (0, react_hotkeys_hook_1.useHotkeys)('esc', function (e) {
        e.preventDefault();
        e.stopPropagation();
        setVisible(false);
    }, HOTKEY_OPTIONS);
    (0, react_hotkeys_hook_1.useHotkeys)('up', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    (0, react_hotkeys_hook_1.useHotkeys)('down', function (e) {
        e.preventDefault();
        e.stopPropagation();
        setSelectedIndex(function (last) {
            var _a;
    ...
    (0, react_hotkeys_hook_1.useHotkeys)('enter', function (e) {
        e.preventDefault();
        e.stopPropagation();
        if (selectedIndex < 0)
            return;
    ...
    return react_dom_1.default.createPortal(!visible ? null : ((0, jsx_runtime_1.jsxs)(Container, { children: [(0, jsx_runtime_1.jsx)(Background, { onClick: toggleVisible }), (0, jsx_runtime_1.jsxs)(Content, { children: [(0, jsx_runtime_1.jsxs)(SearchBar, __assign({ "$hasResults": !!(indexedResults === null || indexedResults === void 0 ? void 0 : indexedResults.length) }, { children: [(0, jsx_runtime_1.jsx)(SearchInput, { onFocus: function () { return setSelectedIndex(-1); }, autoFocus: true, ref: inputRef, placeholder: 'Search or jump to...', value: search, onChange: handleInputChange }), (0, jsx_runtime_1.jsx)(line_1.SearchIcon, { size: 24, color: 'gray4' }), (search === null || search === void 0 ? void 0 : search.length) > 0 && ((0, jsx_runtime_1.jsx)(CloseButton, __assign({ onClick: handleClearSearch }, { children: (0, jsx_runtime_1.jsx)(line_1.TimesIcon, { size: 8, color: 'gray10' }) })))] })), !!indexedResults.length && ((0, jsx_runtime_1.jsx)(Results, { children: indexedResults.map(function (command, index) { return ((0, jsx_runtime_1.jsx)(result_1.Result, { hasIcons: hasIcons, command: command, index: index, selected: selectedIndex === index, onSoftSelect: setSelectedIndex, onComplete: toggleVisible }, command.id)); }) }))] })] })), wrapper);
}
...
var SearchBar = styled_components_1.default.div(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n    position: relative;\n    ", "\n\n    ", "\n\n    > svg {\n        position: absolute;\n        left: 15px;\n        margin-bottom: 2px;\n    }\n"], ["\n    position: relative;\n    ", "\n\n    ", "\n\n    > svg {\n        position: absolute;\n        left: 15px;\n        margin-bottom: 2px;\n    }\n"])), function (p) { return p.theme.flex.row({ align: 'center' }); }, function (p) { return p.$hasResults && "\n        border-bottom: 1px solid ".concat(p.theme.color.gray8, ";\n    "); });
var SearchInput = styled_components_1.default.input(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n    ", "\n    flex: 1;\n    height: 55px;\n    padding: 0 50px;\n\n    ::placeholder {\n        color: ", " !important;\n    }\n"], ["\n    ", "\n    flex: 1;\n    height: 55px;\n    padding: 0 50px;\n\n    ::placeholder {\n        color: ", " !important;\n    }\n"])), function (p) { return p.theme.text.System.regular(18, 'gray1'); }, function (p) { return p.theme.color.gray6; });
var Results = styled_components_1.default.div(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n    ", ";\n    height: auto;\n    overflow-y: auto;\n    max-height: 400px;\n    padding: 8px;\n\n    @media(max-height: 600px) {\n        max-height: 100%;\n    }\n"], ["\n    ", ";\n    height: auto;\n    overflow-y: auto;\n    max-height: 400px;\n    padding: 8px;\n\n    @media(max-height: 600px) {\n        max-height: 100%;\n    }\n"])), function (p) { return p.theme.flex.col(); });
