...
function SpotlightComponent() {
    ...
    return react_dom_1.default.createPortal(!visible ? null : ((0, jsx_runtime_1.jsxs)(Container, Object.assign({ id: 'fooxly-spotlight' }, { children: [(0, jsx_runtime_1.jsx)(Background, { onClick: hideSpotlight }), (0, jsx_runtime_1.jsxs)(Content, { children: [(0, jsx_runtime_1.jsx)(search_input_1.SearchInput, { type: spotlightType, hasResults: !!(indexedResults === null || indexedResults === void 0 ? void 0 : indexedResults.length) || !!error, placeholder: spotlightType === 'input' ? placeholder !== null && placeholder !== void 0 ? placeholder : 'Enter text here...' : fallbackTitle, value: search, loading: loading, fref: inputRef, 
                        ...
                        indexedResults[0].results.length > 0 && ((0, jsx_runtime_1.jsx)(Results, Object.assign({ ref: resultsRef }, { children: indexedResults.map((category) => ((0, jsx_runtime_1.jsx)(section_1.Section, { title: category.title, results: category.results, showIcons: resultsHaveIcons, selectedIndex: selectedIndex, 
                            // eslint-disable-next-line react/jsx-handler-names
