...
function SpotlightComponent() {
    ...
    return react_dom_1.default.createPortal(!visible ? null : ((0, jsx_runtime_1.jsxs)(Container, { id: 'fooxly-spotlight', children: [(0, jsx_runtime_1.jsx)(Background, { onClick: hideSpotlight }), (0, jsx_runtime_1.jsxs)(Content, { children: [(0, jsx_runtime_1.jsx)(search_input_1.SearchInput, { hasResults: !!indexedResults?.length || !!error, placeholder: subMenuItem ? 'Choose an option...' : 'Search or jump to...', value: search, loading: loading, fref: inputRef, 
                        // eslint-disable-next-line react/jsx-handler-names
                        onChange: setSearch }), !!error && ((0, jsx_runtime_1.jsx)(error_1.Error, { message: error, onDismiss: () => setError('') })), indexedResults.length > 0 && indexedResults[0].results.length > 0 && ((0, jsx_runtime_1.jsx)(Results, { ref: resultsRef, children: indexedResults.map((category) => ((0, jsx_runtime_1.jsx)(section_1.Section, { title: category.title, results: category.results, showIcons: resultsHaveIcons, selectedIndex: selectedIndex, 
                            // eslint-disable-next-line react/jsx-handler-names
