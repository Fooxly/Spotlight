...
function SpotlightComponent({ showTips }) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
        document.removeEventListener(utils_1.UPDATE_SPOTLIGHT_EVENT_KEY, forceUpdateSpotlight, false);
        // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
        document.addEventListener(utils_1.UPDATE_SPOTLIGHT_EVENT_KEY, forceUpdateSpotlight, false);
