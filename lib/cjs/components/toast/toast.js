...
let toastWrapper = document.querySelector('#spotlight-toast');
if (!toastWrapper) {
...
function Toast() {
    ...
    (0, react_1.useEffect)(() => {
        ...
        document.removeEventListener(utils_1.TOAT_EVENT_KEY, handleNewToastMessage, false);
        // eslint-disable-next-line @typescript-eslint/no-unsafe-argument
        document.addEventListener(utils_1.TOAT_EVENT_KEY, handleNewToastMessage, false);
