...
function Toast() {
    ...
    if (!toastWrapper)
        return null;
    return react_dom_1.default.createPortal(!message ? null : ((0, jsx_runtime_1.jsx)(Container, { children: (0, jsx_runtime_1.jsxs)(Pill, Object.assign({ "$enabled": show }, { children: [(0, jsx_runtime_1.jsx)(line_1.InfoIcon, { size: 28, color: 'blue' }), (0, jsx_runtime_1.jsx)(Text, { children: message })] })) })), toastWrapper);
}
exports.Toast = Toast;
