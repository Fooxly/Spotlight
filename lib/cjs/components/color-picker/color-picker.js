...
function ColorPicker() {
    ...
    if (typeof window === 'undefined')
        return null;
    return react_dom_1.default.createPortal(!visible ? null : ((0, jsx_runtime_1.jsxs)(Container, Object.assign({ ref: colorPickerRef, onMouseUp: () => setAreaFocus(false) }, { children: [(0, jsx_runtime_1.jsx)(Background, { onClick: hideColorPicker }), (0, jsx_runtime_1.jsxs)(Content, { children: [(0, jsx_runtime_1.jsx)(Picker, Object.assign({ ref: colorAreaDimsRef, onMouseDown: () => setAreaFocus(true), style: {
