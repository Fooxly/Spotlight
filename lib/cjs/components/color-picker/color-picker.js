...
function ColorPicker({ setColorGrabberProps }) {
    ...
    const handleGrab = () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const canvas = yield (0, html2canvas_1.default)(document.body, {
                logging: false,
            ...
            setColorGrabberProps({
                ...
                onGrab: (hex) => {
                    ...
                    setTimeout(() => {
                        const hsva = (0, colors_1.RGBAtoHSVA)((0, colors_1.HexToRGBA)(hex));
                        setHue(hsva.h);
                        setPosition({
...
const Row = styled_components_1.default.div `
    ...
    column-gap: 10px;
`;
const ColorGrabberButton = styled_components_1.default.button `
    ${(p) => p.theme.flex.row({ justify: 'center', align: 'center' })}
    ${(p) => p.theme.text.System.regular(15, 'gray1')}
    border: 2px solid ${(p) => p.theme.color.gray7};
    outline: 0;
