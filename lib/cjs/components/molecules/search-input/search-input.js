...
function SearchInput({ type, forwardRef, value, onValueChange }) {
    var _a;
    const { placeholder, loading } = (0, utils_1.useSearchContext)();
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({ className: 'spotlight-search-input' }, { children: [(0, jsx_runtime_1.jsx)("input", { autoFocus: true, ref: forwardRef, placeholder: formattedPlaceholder, className: 'spotlight-search-input-input', type: 'text', value: value !== null && value !== void 0 ? value : '', onChange: handleValueChange, disabled: loading }), (0, jsx_runtime_1.jsx)("div", Object.assign({ className: 'spotlight-search-input-icon' }, { children: type === 'select' || type === 'input' ? ((0, jsx_runtime_1.jsx)(line_1.ArrowIcon, { direction: 'right', size: 24, color: 'gray4' })) : loading ? ((0, jsx_runtime_1.jsx)(atoms_1.Loading, { size: 22, color: 'blue', thickness: 3 })) : ((0, jsx_runtime_1.jsx)(line_1.SearchIcon, { size: 24, color: 'gray4' })) })), ((_a = value === null || value === void 0 ? void 0 : value.length) !== null && _a !== void 0 ? _a : 0) > 0 && ((0, jsx_runtime_1.jsx)("button", Object.assign({ className: 'spotlight-search-input-clear', onClick: () => onValueChange('') }, { children: (0, jsx_runtime_1.jsx)(line_1.TimesIcon, { size: 8, color: 'gray10' }) })))] })));
}
