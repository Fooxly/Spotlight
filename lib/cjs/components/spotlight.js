...
function SpotlightComponent() {
    ...
    return react_dom_1.default.createPortal(!visible ? null : ((0, jsx_runtime_1.jsxs)(Container, { children: [(0, jsx_runtime_1.jsx)(Background, { onClick: hideSpotlight }), (0, jsx_runtime_1.jsxs)(Content, { children: [(0, jsx_runtime_1.jsxs)(SearchBar, { "$hasResults": !!indexedResults?.length, children: [(0, jsx_runtime_1.jsx)(SearchInput, { onFocus: () => setSelectedIndex(-1), autoFocus: true, ref: inputRef, placeholder: 'Search or jump to...', value: search, onChange: handleInputChange }), (0, jsx_runtime_1.jsx)(line_1.SearchIcon, { size: 24, color: 'gray4' }), search?.length > 0 && ((0, jsx_runtime_1.jsx)(CloseButton, { onClick: handleClearSearch, children: (0, jsx_runtime_1.jsx)(line_1.TimesIcon, { size: 8, color: 'gray10' }) }))] }), !!indexedResults.length && ((0, jsx_runtime_1.jsxs)(Results, { children: [!!pages.length && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(ResultSection, { children: (0, jsx_runtime_1.jsx)(ResultSectionTitle, { children: "Pages" }) }), pages.map((item) => {
