...
let spotlightColorGrabberWrapper: HTMLDivElement | null = null;
if (typeof window !== 'undefined') {
    spotlightColorGrabberWrapper = document.querySelector<HTMLDivElement>('#spotlight-colorgrabber');
...
export type ColorGrabberProps = Props;
interface Props {
    onGrab?: (hex: string) => void;
    frame?: string;
    visible?: boolean;
}
...
export function ColorGrabber ({ onGrab, frame, visible = false }: Props): JSX.Element | null {
